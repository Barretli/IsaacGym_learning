...
#heightfield[0:num_rows, :] = random_uniform_terrain(new_sub_terrain(), min_height=-0.5, max_height=0.5, step=0.3, downsampled_scale=1).height_field_raw
#heightfield[0:num_rows, :] = sloped_terrain(new_sub_terrain(), slope=0.5).height_field_raw
#heightfield[0:num_rows, :] = pyramid_sloped_terrain(new_sub_terrain(), slope=-0.8).height_field_raw
#heightfield[0:num_rows, :] = discrete_obstacles_terrain(new_sub_terrain(), max_height=0.8, min_size=3., max_size=5., num_rects=15).height_field_raw
#heightfield[0:num_rows, :] = wave_terrain(new_sub_terrain(), num_waves=3., amplitude=2.).height_field_raw
#heightfield[0:num_rows, :] = stairs_terrain(new_sub_terrain(), step_width=1, step_height=0.5).height_field_raw
#heightfield[0:num_rows, :] = pyramid_stairs_terrain(new_sub_terrain(), step_width=0.75, step_height=0.8).height_field_raw
heightfield[0:num_rows, :] = stepping_stones_terrain(new_sub_terrain(), stone_size=2,
                                                              stone_distance=1, max_height=0.1, platform_size=0.).height_field_raw
